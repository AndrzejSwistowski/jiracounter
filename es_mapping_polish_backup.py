...
CHANGELOG_MAPPING_POLISH = {
    ...
    "mappings": {
        "properties": {
            ...
            "components": {"type": "text", "fields": {"keyword": {"type": "keyword"}}},            "summary": {
                "type": "text", 
            ...
            # Content fields with comprehensive text analysis for Polish searching            "description": {
                "type": "text",
                "analyzer": "polish_standard",
                "fields": {
            ...
            "selected_for_development_at": {"type": "date"},            "backlog": {
                "properties": {
                    "working_minutes": {"type": "integer"},
                    "working_days": {"type": "integer"},
                    "period": {"type": "text"}
