#!/usr/bin/env python3
"""
Test script to verify the ES document formatter works with comprehensive records.
"""
...
def test_comprehensive_formatting():
    """Test formatting of comprehensive records for ES."""
    print("Testing comprehensive record formatting...")
    
    # Create a sample comprehensive record
    sample_record = {
        'issue_data': {
            'issueId': '12345',
            'key': 'TEST-123',
    ...
    try:
        ...
        print(f"❌ Error testing comprehensive formatting: {e}")
        import traceback
        traceback.print_exc()
        return False
...
if __name__ == "__main__":
    print("🧪 Testing ES Comprehensive Record Formatting")
    print("=" * 50)
    ...
    print("\n" + "=" * 50)
    if success:
        print("🎉 All tests passed! ES comprehensive formatting is working correctly.")
    else:
